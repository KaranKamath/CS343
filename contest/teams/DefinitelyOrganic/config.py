...
# Alpha-Numeric only
TeamName = 'DefinitelyOrganic'

# Filename.FactoryClassName (CASE-sensitive)
AgentFactory = 'definitelyOrganic.DefinitelyOrganicAgents'

Partners = ['Karan Kamath']

AgentArgs = {'first':'smartoffensev2', 'second':'smartdefensev2', 'rest': 'smartoffensev2'}
